...
export class ApiService {
  ...
  public get<Res>(path: string): Observable<Res> {
    return this.http
  ...
  public post<Req, Res>(path: string, body: Req): Observable<Res> {
    return this.http
  ...
  public patch<Req, Res>(path: string, body: Req): Observable<Res> {
    return this.http
